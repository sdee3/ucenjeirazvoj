...
export default function Promo() {
  return (
    <section className='home-page__promo'>
      <div className='home-page__promo-image'>
        <img
          src='https://res.cloudinary.com/sdee3-com/image/upload/v1591342895/ucenjeirazvoj/ucenje-i-razvoj-featured-min.png'
          alt='Učenje i razvoj promo'
        />
        <div className='home-page__promo-text'>
          <h3>
            “Čovek proputuje svet u potrazi za onim što mu je potrebno, a onda
            se vrati kući i pronađe upravo to što je tražio.”
          </h3>
          <h3>Džordž Mur</h3>
        </div>
      </div>
